                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        tampilan = `
                            <div class="ms-auto">
                                ...
                                <a class="btn btn-link text-success text-gradient px-3 mb-0" href="/admin/halaman-kunjungi-customer-temp/${row.kode}"><i class="fa fa-eye me-2"></i>Daftar Customer</a>
                                </div>
                                `
