        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDetailDataLaporanTransaksiLabel">Detail Laporan BPPBM</h5>
...
@section('script')
    <script>
        ...
        const table_laporan_data_transaksi = $('#table-data-transaksi').DataTable({
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        daftar_laporan_data_transaksi[row.id] = row;
                        return row.relasi_customer.kode;
                    }
                },
                {
                    "targets": 3,
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        tampilan = `
                            <div class="ms-auto">
                                <a class="btn btn-link text-warning text-gradient px-3 mb-0 click_transaksi" transaksi-id="${row.id}" href="#!"><i class="fa fa-eye me-2"></i>Detail</a>
                            </div>
                                `
                        return tampilan;
                    }
        ...
        $(document).on('click', '.click_transaksi', function(event) {
            ...
            $("#formDetailDataLaporanTransaksi [name='kode_sales']").val(data_transaksi.relasi_perjalanan.relasi_sales.kode);
