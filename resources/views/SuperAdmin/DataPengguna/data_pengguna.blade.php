                            ...
                            <div class="modal fade text-left" id="modalTambahPengguna" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('superadmin.TambahDataPengguna') }}" id="formTambahPengguna"
                                            method="POST">
                                            @csrf
    ...
    <div class="modal fade text-left" id="modalEditPengguna" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="formEditPengguna" action="{{ route('superadmin.UbahDataPengguna') }}" method="POST">
...
@section('script')
    <script>
        ...
        const table_data_pengguna = $('#table-data-pengguna').DataTable({
            ...
            "sScrollXInner": "100%",
            ajax: {
                url: "{{ route('superadmin.DataPengguna') }}",
                type: "POST",
                headers: {
        ...
        $(document).on('click', '.hapus_pengguna', function(event) {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "/superadmin/hapus-data-pengguna/" + id,
                        dataType: 'json',
