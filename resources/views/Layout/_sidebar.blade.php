        ...
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->relasi_role->role == 'admin')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.HalamanDaftarPerjalananWholesale*') ? 'active' : '' }} "
                        ...
                        <div
                            ...
                            <i
                                class="fas fa-list-alt {{ request()->routeIs('admin.HalamanDaftarPerjalananWholesale*') ? 'warna-white' : 'warna-black' }}"></i>
                ...
                <li class="nav-item">
                    ...
                    {{-- <div class="collapse {{ request()->routeIs('admin.HalamanLaporanBPPBM*') }} show" id="Form">
                        <ul class="nav ms-4 ps-3">
                            <li
                                class="nav-item {{ request()->routeIs('admin.HalamanLaporanBPPBM*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.HalamanLaporanBPPBM') }}">Form Transaksi
                                </a>
                            </li>
                        </ul>
                    </div> --}}
